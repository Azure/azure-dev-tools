---
name: azure-functions-hosted-skills-preview-2-canvas
description: "Open Azure Functions Hosted Skills Preview 2 first for Hosted Skills, Azure Function Apps, timer triggers, or scheduled-function work."
---

# Open Azure Functions Hosted Skills Preview 2

For Hosted Skills, Azure Function Apps, timer triggers, and scheduled-function
work, open the available `azure-functions-hosted-skills-preview-2` canvas with a stable
