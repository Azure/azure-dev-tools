# Azure Functions Hosted Skills Preview 2
...
```text
https://github.com/Azure/azure-dev-tools/tree/functions-canvas-preview-2-install-validation/canvases/azure-functions-hosted-skills-preview-2/
```
