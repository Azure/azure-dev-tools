# Azure Functions Hosted Skills Preview 6

This diagnostic install-validation preview focuses on local source,
subscription, and model state settling. Model creation is not included.
...
```text
https://github.com/Azure/azure-dev-tools/tree/functions-canvas-preview-6-diagnostic/canvases/azure-functions-hosted-skills-preview-6/
```
