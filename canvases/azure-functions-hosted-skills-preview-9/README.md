# Azure Functions Hosted Skills (preview-9)
...
```text
https://github.com/Azure/azure-dev-tools/tree/main/canvases/azure-functions-hosted-skills-preview-9/
```

Then ask Copilot:

```text
Open Azure Functions Hosted Skills (preview-9)
```
