---
name: azure-functions-hosted-skills-preview-9-canvas
description: "Open Azure Functions Hosted Skills (preview-9) first for Hosted Skills, Azure Function Apps, timer triggers, or scheduled-function work."
---

# Open Azure Functions Hosted Skills (preview-9)

For Hosted Skills, Azure Function Apps, timer triggers, and scheduled-function
work, open the available `azure-functions-hosted-skills-preview-9` canvas with a stable
