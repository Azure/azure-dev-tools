# Azure Functions Hosted Skills Preview 4
...
```text
https://github.com/Azure/azure-dev-tools/tree/functions-canvas-preview-4-validation/canvases/azure-functions-hosted-skills-preview-4/
```
