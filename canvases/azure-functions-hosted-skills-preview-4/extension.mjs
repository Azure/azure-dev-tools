...
const DISPLAY_NAME = "Azure Functions Hosted Skills Preview 4";
...
const OWNERSHIP_DIRECTORY = ".azure-functions-hosted-skills-preview-4";
...
const canvas = createCanvas({
	id: "azure-functions-hosted-skills-preview-4",
