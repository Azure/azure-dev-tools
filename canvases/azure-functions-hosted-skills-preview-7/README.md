# Azure Functions Hosted Skills Preview 7
...
```text
https://github.com/Azure/azure-dev-tools/tree/functions-canvas-preview-7-validation/canvases/azure-functions-hosted-skills-preview-7/
```

Then ask Copilot:

```text
Open Azure Functions Hosted Skills Preview 7
```
...
<!-- HERO:WORKSPACE -->
3. Choose **New local function** to create a local workspace. The canvas copies
   its exact bundled starter into its dedicated workspace root without changing
   an existing or unowned folder.
<!-- HERO:MODEL -->
