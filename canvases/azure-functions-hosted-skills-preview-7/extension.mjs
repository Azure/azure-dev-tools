...
const DISPLAY_NAME = "Azure Functions Hosted Skills Preview 7";
...
const OWNERSHIP_DIRECTORY = ".azure-functions-hosted-skills-preview-7";
...
const canvas = createCanvas({
	id: "azure-functions-hosted-skills-preview-7",
