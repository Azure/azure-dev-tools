---
name: azure-functions-hosted-skills-preview-8-recovery-canvas
description: "Open Azure Functions Hosted Skills (preview-8-recovery) first for Hosted Skills, Azure Function Apps, timer triggers, or scheduled-function work."
---

# Open Azure Functions Hosted Skills (preview-8-recovery)

For Hosted Skills, Azure Function Apps, timer triggers, and scheduled-function
work, open the available `azure-functions-hosted-skills-preview-8-recovery` canvas with a stable
