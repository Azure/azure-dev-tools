# Azure Functions Hosted Skills (preview-8-recovery)
...
```text
https://github.com/Azure/azure-dev-tools/tree/main/canvases/azure-functions-hosted-skills-preview-8-recovery/
```
