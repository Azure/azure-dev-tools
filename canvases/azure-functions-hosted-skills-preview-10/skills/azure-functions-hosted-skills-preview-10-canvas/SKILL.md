---
name: azure-functions-hosted-skills-preview-10-canvas
description: "Open Azure Functions Hosted Skills (preview-10) first for Hosted Skills, Azure Function Apps, timer triggers, or scheduled-function work."
---

# Open Azure Functions Hosted Skills (preview-10)

For Hosted Skills, Azure Function Apps, timer triggers, and scheduled-function
work, open the available `azure-functions-hosted-skills-preview-10` canvas with a stable
