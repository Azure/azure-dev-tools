...
const DISPLAY_NAME = "Azure Functions Hosted Skills (preview-10)";
...
const OWNERSHIP_DIRECTORY = ".azure-functions-hosted-skills-preview-10";
...
async function initializePublicCanvas(entry) {
	...
	entry.initializePromise = (async () => {
		...
		try {
			...
			autoApplyModel = createdWorkspace && Boolean(entry.state.modelBinding.resourceId && entry.state.modelBinding.modelId);
		} catch (error) {
...
const canvas = createCanvas({
	id: "azure-functions-hosted-skills-preview-10",
