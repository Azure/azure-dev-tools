...
is read-only; workspace and local-host actions always require confirmation.
...
```text
https://github.com/Azure/azure-dev-tools/tree/functions-canvas-preview-install-validation/canvases/azure-functions-hosted-skills-preview/
```
...
5. Update the skill instructions in `src/daily-repo-digest.agent.md`, or use
   **Open in VS Code**.
