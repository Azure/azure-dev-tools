...
const DISPLAY_NAME = "Azure Functions Hosted Skills Preview";
...
const OWNERSHIP_DIRECTORY = ".azure-functions-hosted-skills-preview";
...
const canvas = createCanvas({
	id: "azure-functions-hosted-skills-preview",
