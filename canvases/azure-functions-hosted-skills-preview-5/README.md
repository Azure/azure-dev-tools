# Azure Functions Hosted Skills Preview 5
...
```text
https://github.com/Azure/azure-dev-tools/tree/functions-canvas-preview-5-validation/canvases/azure-functions-hosted-skills-preview-5/
```
