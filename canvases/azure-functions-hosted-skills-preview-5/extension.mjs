...
const DISPLAY_NAME = "Azure Functions Hosted Skills Preview 5";
...
const OWNERSHIP_DIRECTORY = ".azure-functions-hosted-skills-preview-5";
...
const canvas = createCanvas({
	id: "azure-functions-hosted-skills-preview-5",
