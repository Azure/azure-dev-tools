...
installation catalog. SRE Agent's reviewed source revision incorporates the
customer-routing hotfix; its corrected public package and immutable release
tag are still required before the marketplace can merge.
